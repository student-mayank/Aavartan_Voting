...
app.get("/signin", (req, res) => {
  ...
  storedLocations.push({ latitude, longitude });

  // res.status(200).json({
  //   message: "Location data stored in memory successfully",
  //   latitude,
  //   longitude,
  // });
});
...
app.get("/test", (req, res) => {
  ...
  console.log(
    `Location data stored in memory: Latitude ${latitude}, Longitude ${longitude}`
  );
  res.status(200).json({
    message: "Location data stored in memory successfully",
    latitude,
